...
public class ETCGenerator{
    ...
    private void generateETC(int[] jobs , int[] load){
...
//        }
    ...
    public int[][] getETC(int[] jobs , int[] load){
        generateETC(jobs , load);
        return e;
    }
...
//        int ee[][]=new ETCGenerator(29,500,TH.LOW,MH.LOW).getETC();
